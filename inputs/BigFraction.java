...
public class BigFraction
    ...
    public BigFraction(BigInteger num, BigInteger den) {
        ...
        if (P1=BigInteger.ZERO.equals(den)) {
            throw new ZeroException(LocalizedFormats.ZERO_DENOMINATOR);
        }
        if (P2=BigInteger.ZERO.equals(num)) {
            ...
            if (P3=BigInteger.ONE.compareTo(gcd) < 0) {
                num = num.divide(gcd);
                den = den.divide(gcd);
            }

            // move sign to numerator
            if (P4=BigInteger.ZERO.compareTo(den) > 0) {
                num = num.negate();
                den = den.negate();
            }
    ...
    public BigFraction(final double value) throws MathIllegalArgumentException {
        ...
        while (P5=(((m & 0x001ffffffffffffeL) != 0) && ((m & 0x1) == 0))) {
            m = m >> 1;
            ++k;
        }
    ...
    public BigFraction add(final BigFraction fraction) {
        ...
        if (P6=(denominator.equals(fraction.denominator))) {
